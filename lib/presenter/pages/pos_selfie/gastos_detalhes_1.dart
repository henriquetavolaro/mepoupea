                          ...
                          for (var item in gastosList)
                            InkWell(
                              ...
                              child: Card(
                                ...
                                elevation: selectedCategory == item.text ? 4 : 0,
                                child: Padding(
                  ...
                  GroupedListView<dynamic, String>(
                    ...
                    groupSeparatorBuilder: (String groupByValue) {
                      return Align(
                        alignment: Alignment.centerLeft,
                        child: Padding(
                          padding: const EdgeInsets.only(left: 24, bottom: 20, top: 24),
                          child: groupByValue == formattedNow
                              ? Text(
                            'Hoje', style: TextStyles.textTermosLightBlack11,)
                              : groupByValue == formattedYesterday
                              ? Text('Ontem $groupByValue',
