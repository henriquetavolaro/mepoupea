                                  ...
                                  child: PinFieldAutoFill(
                                    ...
                                    onCodeSubmitted: (code) {
                                      sl.get<AuthenticationBloc>().add(
                                          PhoneSignInVerifyEvent(
                                              smsCodeController.text.toString()));
                                    },
                                  ),
                                ),
                              ],
                    ...
                    Align(
                      ...
                      child: InkWell(
                        onTap: () => sl
                            ...
                            .add(PhoneSignInSendCodeEvent(widget.phoneNumber)),
                        child: RichText(
                          text: TextSpan(
                            text: 'Não recebeu? ',
                            style: TextStyles.phoneVerificationSmall11DarkBlue,
                            children: <TextSpan>[
                              TextSpan(
                                  text: 'Reenviar',
                                  style: TextStyles
                                      .phoneVerificationSmall11Underline)
                            ],
                          ),
                        ),
                      ),
